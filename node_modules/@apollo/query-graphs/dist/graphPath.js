...
class GraphPath {
    ...
    add(trigger, edge, conditionsResolution, defer) {
        ...
        return new GraphPath({
            ...
            edgeConditions: this.props.edgeConditions.concat((_b = conditionsResolution.pathTree) !== null && _b !== void 0 ? _b : null),
            subgraphEnteringEdge,
            edgeToTail: edge,
...
function advanceSimultaneousPathsWithOperation(supergraphSchema, subgraphSimultaneousPaths, operation) {
    ...
    for (const [i, path] of subgraphSimultaneousPaths.paths.entries()) {
        ...
        if (!shouldReenterSubgraph) {
            debug.group(() => `Direct options`);
            options = advanceWithOperation(supergraphSchema, path, operation, updatedContext, subgraphSimultaneousPaths.conditionResolver);
        ...
        if (options.length === 0 && shouldReenterSubgraph) {
            ...
            options = (_a = advanceWithOperation(supergraphSchema, path, operation, updatedContext, subgraphSimultaneousPaths.conditionResolver)) !== null && _a !== void 0 ? _a : [];
            debug.groupEnd(() => advanceOptionsToString(options));
        }
        if (options.length === 0) {
            debug.groupEnd();
        ...
        switch (currentType.kind) {
            ...
            case 'UnionType':
                ...
                if (edge) {
                    ...
                    return [[path.add(operation, edge, exports.noConditionsResolution, operation.deferDirectiveArgs())]];
                }
